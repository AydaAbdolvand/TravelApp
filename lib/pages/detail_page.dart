                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          AppLargeText(text: '\$'+detail.place.price.toString(), color: Colors.indigo,),
                      ...
                      Row(children: [
                        ...
                        SizedBox(width: 5,),
                        AppText(text: detail.place.location, color: Color(0xFF5d69b3),),
                        ...
                        children: [
                          Wrap(
                            children: List.generate(5, (index){
                              return Icon(Icons.star,color: index<detail.place.stars?Colors.orangeAccent :Colors.grey,);
                      ...
                      SizedBox(height: 10,),
                      AppText(text: detail.place.description, color: Colors.grey, ),
